...
class FourBandComponent extends Component {
    constructor(props) {
        super(props)
    ...
    fetchResult = () => {
        const { firstColor, secondColor, multiplier, tolerance } = this.state;
        if (firstColor && secondColor && multiplier && tolerance) {
            ResistorServices.retrieve4Band(firstColor, secondColor, multiplier, tolerance)
                .then((response) => {
                    this.setState({
...
export default FourBandComponent;